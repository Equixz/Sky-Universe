...
cfg.gunshop_types = {
	...
	["Politi"] = {
		...
		["WEAPON_SMG"] = {"SMG",0,0,""},
		["WEAPON_CARBINERIFLE"] = {"Karbin-riffel",0,0,""},
		["WEAPON_SMOKEGRENADE"] = {"Tåregas",0,0,""},
		["WEAPON_VINTAGEPISTOL"] = {"Fartmåler",0,0,""},	
	},
	["PET Våbenlager"] = {
...
cfg.gunshops = {
	...
	{"PET", 143.723, -763.592, 242.152,true},
	{"Politi", 451.476,-980.077,30.689,true},
	{"Politi", 1850.2686767578,3685.6057128906,34.286624908447,true},
	{"Politi", -447.05477905273,6008.0986328125,31.716390609741,true}
}
