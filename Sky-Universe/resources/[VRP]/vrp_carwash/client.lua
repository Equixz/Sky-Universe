vehicleWashStation = {
	...
	{735.70764160156,-1073.53515625,22.232948303223},
	{-328.35488891602,-143.9900970459,38.633327484131}, -- Homebase Customs
	{478.85522460938,-1309.3203125,29.233226776123}, -- JAMES AUTO
	{-206.55157470703,-1324.6795654297,30.89038848877}, -- Bennys
}
vehicleWashStationBlips = {
	{25.557371139526,-1391.9454345703,28.467275238037},
	{-74.567901611328,6427.8715820313,30.466750411987},
	{-699.632512312313,-932.7043123123,18.013950411987},
	{2010.3566894531,3790.791015625,31.196670074463},
...
Citizen.CreateThread(function ()
	Citizen.Wait(0)
	for i = 1, #vehicleWashStationBlips do
		garageCoords = vehicleWashStationBlips[i]
		...
		if IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then 
			for i = 1, #vehicleWashStation do
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), garageCoords2[1], garageCoords2[2], garageCoords2[3], true ) < 5 then
					drawTxt('[~g~E~s~] for at vaske dit køretøj', 0, 1, 0.5, 0.8, 0.6, 255, 255, 255, 255)
...
AddEventHandler('carwash:success', function()
	...
	text = "Du betalte <b style='color:#DB4646'>150 DKK</b>",
	type = "success",
	timeout = (3000),
	layout = "centerLeft",
	queue = "global",
