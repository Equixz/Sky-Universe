...
local garages = {
  ...
  {name="Garage", colour=3, id=357, marker=27,  x=1976.6466064453, y=3826.8298339844,  z=31.365600585938, h=0.0, hidden=false}, -- Sandy Shores
  ...
  {name="Garage", colour=3, id=357, marker=27,  x=968.25659179688, y=-91.952758789063,  z=73.431835327148, h=0.0, hidden=true}, -- The Lost MC
