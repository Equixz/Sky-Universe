...
RegisterNetEvent('kaz_holdup:completecheck')
AddEventHandler('kaz_holdup:completecheck', function(storereward, storenameofstore, savedSource, user_id)
	if holdingup == true then 
		TriggerServerEvent('kaz_holdup:completecheck2', storereward, storenameofstore, savedSource, user_id)
	end
end)
...
Citizen.CreateThread(function()
	...
	Citizen.Wait(0)
		if secondsRemaining == 1 then 
			...
			if holdingup then
				holdingup = false
				TriggerServerEvent('kaz:payupbug')
			end
		end
	end
end)
