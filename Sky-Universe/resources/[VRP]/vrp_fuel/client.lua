	...
	local isEngineOn = Citizen.InvokeNative(0xAE31E7DF9B5B132E, GetVehiclePedIsIn(GetPlayerPed(-1)))
		...
		if isEngineOn then
			if isRadarExtended then
				...
				DrawAdvancedText(0.4850, 0.9895, 0.125, 0.0028, 0.42,round(percent,1), 255, 255, 255, 220, 0, 1)
			...
			DrawAdvancedText(0.5050, 0.9895, 0.125, 0.0028, 0.42,"%", 255, 255, 255, 220, 0, 1)
		end
    end
end
