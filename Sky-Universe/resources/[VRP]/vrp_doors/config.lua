...
cfg.doors = {
    ...
    -- SALGSSTEDER 
            [40] = { locked = true, key = "", permission="sellroom.whitelisted", name = "Købmanden", hash =  "v_ilev_epsstoredoor", coords={ 242.5555, 360.6089,105.8533}},      
    -- FÆNGSEL
	...
	-- NIGHTCLUB
			[58] = { locked = true, key = "9", permission="", name = "Natklub", hash =  "ba_prop_door_club_glass", coords={ -1621.751953125,-3015.9489746094,-75.205078125}},
			[59] = { locked = true, key = "9", permission="", name = "Natklub", hash =  "ba_prop_door_club_glam_generic", coords={ -1621.3787841797,-3019.1606445313,-75.205078125}},
			[60] = { locked = true, key = "9", permission="", name = "Natklub", hash =  "ba_prop_door_club_generic_vip", coords={ -1607.4812011719,-3006.1018066406,-75.205146789551}},
			[61] = { locked = true, key = "9", permission="", name = "Natklub", hash =  "ba_prop_door_club_edgy_generic", coords={ -1583.4389648438,-3005.720703125,-76.004959106445}},
