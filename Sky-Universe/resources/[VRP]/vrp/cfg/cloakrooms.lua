...
local doctor_falck = { model = "s_m_m_paramedic_01"}
local politi_1 = { model = "s_f_y_cop_01"}
local politi_3 = { model = "s_m_y_cop_01"}
local politi_4 = { model = "s_m_y_hwaycop_01"}
local politi_5 = { model = "s_m_y_swat_01"}
local politi_6 = { model = "s_m_y_sheriff_01"}
local politi_7 = { model = "s_m_m_ciasec_01"}
...
-- Politi
	["Politi"] = {
		...
		["Politi (Mand)"] = politi_6,
		["Politi (Dame)"] = politi_1,
		["Politi m/ Jakke(Mand)"] = politi_3,
		["Færdsel (Mand)"] = politi_4,
		["Swat (Mand)"] = politi_5,
		["CivilPoliti-Job (Mand)"] = politi_7
...
-- EMS-Job
	["EMS-Job"] = {
		_config = {
			permissions = {"doctor.cloakroom"}
		},
		["EMS-Job outfit"] = doctor_falck,
		["EMS-Job outfit"] = doctor_falck
	}
}
