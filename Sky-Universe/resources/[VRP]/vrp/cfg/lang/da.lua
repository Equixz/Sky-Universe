...
local lang = {
  common = {
    welcome = "<center>Velkommen til <b style='color: #7fcaff'>Sky-Universe</b>.<br>Tryk på <b style='color: #7fcaff'>F9</b> for at åbne menuen.</center>",
  ...
  business = {
    ...
    open = {
      ...
      prompt_name = "Virksomhedsnavn (kan ikke ændres, max {1} karakter):",
      prompt_capital = "Kapital (min {1})",
      created = "Virksomhed startet."
  ...
  cityhall = {
    ...
    menu = {
      title = "Identitet",
      info = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Alder</b>: {3} år<br /><b>CPR</b>: {4}-{11}<br /><b>Mobilnummer</b>: {5}<br /><b>Bankkonto</b>: {10} DKK<br /><b>Pengepung</b>: {9} DKK<br /><b>Kørekort</b>: {8}<br /><b>Adresse</b>: {6} {7}"
    }
  },
  police = {
    title = "Politi",
    ...
    identity = {
      info = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Alder</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Mobilnummer</b>: {5}<br /><br /><b>Adresse</b>: {8} {9}"
    }
  },
  emergency = {
  title = "EMS-Job",
    menu = {
      ...
      firstaid = {
        ...
        description = "Red en person fra døden ved at udøve førstehjælp. Kræver førstehjælpskursus. Bør ikke benyttes, hvis EMS-Jobr er til rådighed.",
        not_in_coma = "Personen er ikke faldet om."
      },
      heal = {
  ...
  closealldoors = {
    ...
    replace = {
      ...
      removekaz = {
      title = "Fjern Køretøj",
      description = "Fjerner køretøjet (Når alt andet fejler)."
    },
      wash = {
      title = "Vask køretøj",
      description = "Vask køretøj."
    },
    repair = {
