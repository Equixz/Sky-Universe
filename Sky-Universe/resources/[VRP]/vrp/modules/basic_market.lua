              ...
              if new_weight <= vRP.getInventoryMaxWeight(user_id) then
                ...
                if vRP.tryFullPayment(user_id,amount*price) then						
                  vRP.giveInventoryItem(user_id,idname,amount,true)
					if vRP.getItemName(idname) == "Desert Eagle" then
						PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/606747271383482368/DC3EbKEIJ-fyuJ23xDBzot3IgxgIt8TUM39xLYxLHOZTIPKXg6ezHhp3cUk0QJBblBHG', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0"), content = "**ID: "..user_id.." ** købte **"..amount.." stk. "..vRP.getItemName(idname).."**"}), { ['Content-Type'] = 'application/json' })
						...
						elseif vRP.getItemName(idname) == "Tung Pistol" then
						PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/606747271383482368/DC3EbKEIJ-fyuJ23xDBzot3IgxgIt8TUM39xLYxLHOZTIPKXg6ezHhp3cUk0QJBblBHG', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0"), content = "**ID: "..user_id.." ** købte **"..amount.." stk. "..vRP.getItemName(idname).."**"}), { ['Content-Type'] = 'application/json' })
						TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.money.paid({amount*price})}, type = "success", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
						elseif vRP.getItemName(idname) == "Pistol MK2" then
						PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/606747271383482368/DC3EbKEIJ-fyuJ23xDBzot3IgxgIt8TUM39xLYxLHOZTIPKXg6ezHhp3cUk0QJBblBHG', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0"), content = "**ID: "..user_id.." ** købte **"..amount.." stk. "..vRP.getItemName(idname).."**"}), { ['Content-Type'] = 'application/json' })
						TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.money.paid({amount*price})}, type = "success", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
						elseif vRP.getItemName(idname) == "Revolver" then
						PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/606747271383482368/DC3EbKEIJ-fyuJ23xDBzot3IgxgIt8TUM39xLYxLHOZTIPKXg6ezHhp3cUk0QJBblBHG', function(err, text, headers) end, 'POST', json.encode({username = "Server " .. GetConvar("servernumber","0"), content = "**ID: "..user_id.." ** købte **"..amount.." stk. "..vRP.getItemName(idname).."**"}), { ['Content-Type'] = 'application/json' })
						TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.money.paid({amount*price})}, type = "success", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
						else
          TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.money.paid({amount*price})}, type = "success", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})               
