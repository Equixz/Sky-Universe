...
local function build_entry_menu(user_id, home_name)
  ...
  TriggerClientEvent("pNotify:SendNotification", player,{text = {"Kontakt en Ejendomsmægler."}, type = "info", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
   -- vRP.getUserAddress(user_id, function(address)
