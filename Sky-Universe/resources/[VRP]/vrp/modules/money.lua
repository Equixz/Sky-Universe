      ...
      if nplayer ~= nil then
        ...
        if nuser_id ~= nil then
          ...
          vRP.prompt(player,lang.money.give.prompt(),"",function(player,amount)
            ...
            PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/606747585587445780/eUXzPLzR9e-nYNBTZf9z-q8pDyjEdKDhhD1Yqsq_SOvH5rVqlzaQDSeIYoQDcG3H6zQK', function(err, text, headers) end, 'POST', json.encode({username = "Kontant", content = "```Borger ID: "..user_id.." gav "..amount.." DKK til ID: "..nuser_id.."```"}), { ['Content-Type'] = 'application/json' })
            else
