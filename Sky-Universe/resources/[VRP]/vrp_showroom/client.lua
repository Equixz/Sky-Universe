	...
	menu = {
		...
		["Coupéer"] = {
			...
			buttons = {
				...
				{name = "F620", costs = 1480000, description = {}, model = "f620"},
				{name = "Felon GT", costs = 1390000, description = {}, model = "felon2"},
				{name = "Jackal", costs = 1690000, description = {}, model = "jackal"},
				{name = "Oracle", costs = 650000, description = {}, model = "oracle"},
				{name = "Oracle XS", costs = 1200000, description = {}, model = "oracle2"},
				{name = "Sentinel", costs = 1150000, description = {}, model = "sentinel"},
				{name = "Sentinel XS", costs = 1000000, description = {}, model = "sentinel2"},
				{name = "BMW E30 M3", costs = 2400000, description = {}, model = "sentinel3"},
				{name = "Windsor", costs = 1600000, description = {}, model = "windsor"},
				{name = "Windsor Drop", costs = 1200000, description = {}, model = "windsor2"},
				{name = "Zion", costs = 1420000, description = {}, model = "zion"},
				{name = "FlashGT", costs = 450000, description = {}, model = "flashgt"},
				{name = "Zion Cabrio", costs = 1250000, description = {}, model = "zion2"},
				{name = "Specter", costs = 2700000, description = {}, model = "specter"},
				{name = "Specter CTM", costs = 3000000, description = {}, model = "specter2"},
				{name = "Monroe", costs = 1700000, description = {}, model = "monroe"},
				{name = "8f Drafter", costs = 8000000, description = {}, model = "drafter"},
				{name = "Ubermecht Zion", costs = 750000, description = {}, model = "zion3"},
				{name = "Nebula", costs = 350000, description = {}, model = "nebula"},
			}
		},
		["Sportsvogne"] = {
			title = "Sportsvogne",
			name = "Sportsvogne",
			buttons = {
				{name = "Banshee", costs = 3300000, description = {}, model = "banshee"},
				{name = "Buffalo", costs = 2100000, description = {}, model = "buffalo"},
				{name = "Buffalo S", costs = 2100000, description = {}, model = "buffalo2"},
				{name = "Carbonizzare", costs = 3500000, description = {}, model = "carbonizzare"},
				{name = "Coquette", costs = 4000000, description = {}, model = "coquette"},
				{name = "Furore GT", costs = 1700000, description = {}, model = "furoregt"},
				{name = "Fusilade", costs = 1000000, description = {}, model = "fusilade"},
				{name = "Hijak Ruston", costs = 4000000, description = {}, model = "ruston"},
		...
		["Sportsklassikere"] = {
			...
			buttons = {
				...
				{name = "Stirling GT", costs = 1200000, description = {}, model = "feltzer3"},
				{name = "Z-Type", costs = 350000, description = {}, model = "ztype"},
				{name = "Btype 3", costs = 4275000, description = {}, model = "btype3"},		
				{name = "Retinue", costs = 350000, description = {}, model = "retinue"},
				{name = "Torero", costs = 3000000, description = {}, model = "torero"},
				{name = "Cheetah Classic", costs = 3500000, description = {}, model = "cheetah2"},
		...
		["Superbiler"] = {
			...
			{name = "Grotti Itali", costs = 10000000, description = {}, model = "italigto"},
			{name = "Übermacht SC1", costs = 3100000, description = {}, model = "sc1"},
			{name = "Benefactor Krieger", costs = 12500000, description = {}, model = "krieger"},
			{name = "Neo", costs = 9000000, description = {}, model = "neo"},
			{name = "Paragon", costs = 8500000, description = {}, model = "paragon"},
			{name = "Zorrusso", costs = 20000000, description = {}, model = "zorrusso"},
			{name = "Progen Emerus", costs = 13000000, description = {}, model = "emerus"},
			}
		},
		["Muskelbiler"] = {
			title = "Muskelvogne",
			...
			buttons = {
				...
				{name = "Deviant", costs = 1450000, description = {}, model = "deviant"},
				...
				{name = "Ellie", costs = 1325000, description = {}, model = "ellie"},
				{name = "Virgo", costs = 150000, description = {}, model = "virgo"},
				{name = "Vapid Clique", costs = 625000, description = {}, model = "clique"},
				{name = "Bravado Gauntlet", costs = 750000, description = {}, model = "gauntlet"},
				...
				{name = "Gauntlet Classic", costs = 2500000, description = {}, model = "gauntlet3"},
			}
		},
		["Offroad"] = {
			title = "Offroad",
			...
			buttons = {
				...
				{name = "Vapid Caracara", costs = 1700000, description = {}, model = "caracara2"},
				{name = "Annis Hellion", costs = 450000, description = {}, model = "hellion"},
			}
		},
		["SUV"] = {
			title = "SUV",
			...
			buttons = {
				...
				{name = "Novak", costs = 4500000, description = {}, model = "novak"},
			}
		},
		["Varevogne"] = {
			title = "Varevogne",
		...
		["Sedaner"] = {
			...
			buttons = {
				...
				{name = "Cognoscenti", costs = 1340000, description = {}, model = "cognoscenti"},
				{name = "Cognoscenti 55", costs = 1450000, description = {}, model = "cog55"},
		...
		["Motorcykler"] = {
			...
			buttons = {
				...
				{name = "Bati 801", costs = 800000, description = {}, model = "bati"},
				{name = "Bati 801RR", costs = 800000, description = {}, model = "bati2"},
			...
			while #vehshop_blips > 0 do
				...
				for i,b in ipairs(vehshop_blips) do
					...
					if vehshop.opened == false and IsPedInAnyVehicle(vehSR_LocalPed(), true) == false and GetDistanceBetweenCoords(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3],GetEntityCoords(vehSR_LocalPed())) < 1 then
						DrawText3Ds(b.pos.entering[1],b.pos.entering[2],b.pos.entering[3], "~w~[~g~E~w~] for at gennemse køretøjer", 3.0, 7)
						currentlocation = b
						inrange = true
					end
				end
