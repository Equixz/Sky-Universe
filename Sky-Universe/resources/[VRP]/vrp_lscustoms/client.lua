...
local lsc = {
	...
	locations = { -- LSCUSTOMS LOCATIONS -- ADD SERVER LOCKS TOO
		[1] = { locked = false, outside = { x = 537.27026367188, y = -177.33395385742, z = 54.478839874268, heading = 71.187133}, inside = {x = 532.92791748047,y = -182.38499450684,z = 54.242015838623, heading = 128.43862915039}},
		...
		[3] = { locked = false, outside = { x = 1174.811, y = 2649.954, z = 37.37151, heading = 0.450}, inside = {x = 1175.04,y = 2640.216,z = 37.32177, heading = 182.402}},
		[4] = { locked = false, outside = { x = 118.6830, y = 6618.4130, z = 30.9185, heading = 0.450}, inside = {x = 110.8406,y = 6626.568, z = 31.787, heading = 182.402}},
		[5] = { locked = false, outside = { x = -336.40686035156, y = -137.59651184082, z = 38.584342956543, heading = 91.568435668945}, inside = {x = -336.40686035156, y = -137.59651184082, z = 38.584342956543, heading = 91.568435668945}},
		[6] = { locked = false, outside = { x = 731.78741455078, y = -1088.7990722656, z = 21.744165420532, heading = 90.653434753418}, inside = {x = 731.78741455078, y = -1088.7990722656, z = 21.744165420532, heading = 90.653434753418}}, -- Peters Autoservice
		[7] = { locked = false, outside = { x = 450.27392578125, y = -997.44952392578, z = 25.75726890564, heading = 88.856353759766}, inside = {x = 450.27392578125, y = -997.44952392578, z = 25.75726890564, heading = 88.856353759766}},
		...
		if DoesEntityExist(veh) then
			if damage < 995 or not AreAllVehicleWindowsIntact(veh) or IsVehicleDoorDamaged(veh,0) or IsVehicleDoorDamaged(veh,1) or IsVehicleDoorDamaged(veh,2) or IsVehicleDoorDamaged(veh,3) then
				if GetVehicleClass(veh) == 13 then 
					...
					if repairprice < 8000 then repairprice = 8000 end
...
function ButtonSelected(button)
	...
	if repairprice > 50000 then repairprice = 50000 end
	if repairprice < 8000 then repairprice = 8000 end
	if repairprice == 0 then repairprice = 8000 end
...
RegisterNetEvent('kaz_lscustoms:timer')
AddEventHandler('kaz_lscustoms:timer', function(timer)
exports['kaz_progressbar']:startUI(timer, "Bilen bliver fixet")
end)
