...
cfg = {
	...
	degradingFailureThreshold = 30.0,			-- Below this value, slow health degradation will set in
	cascadingFailureThreshold = 30.0,			-- Below this value, health cascading failure will set in
