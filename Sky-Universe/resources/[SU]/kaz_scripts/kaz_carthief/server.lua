...
AddEventHandler('kaz_carthief:aflever', function(veh, navn, skade)
  ...
  local user_id = vRP.getUserId({source})
	if vRP.hasGroup({user_id,"Biltyv"}) then
		...
		fortael = round2(skade/1000*100)
			...
			PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Brugeren "..user_id.." afleverede en "..navn..".```"}), { ['Content-Type'] = 'application/json' })
	else
		TriggerClientEvent("pNotify:SendNotification", source,{text = "Du er ikke Biltyv!", type = "error", queue = "global", timeout = 8000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})
	end
end)
...
AddEventHandler('kaz_carthief:nyfunktion', function()
  local source = source
  local user_id = vRP.getUserId({source})
		if vRP.hasInventoryItem({user_id,"lockpicking_kit",1}) then 
	...
	if vRP.hasGroup({user_id,"Biltyv"}) then
		if vRP.hasInventoryItem({user_id,"lockpicking_kit",1}) then 
			if vRP.tryGetInventoryItem({user_id,"falsknummerplade",1,false}) then
				...
				PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Brugeren "..user_id.." udskiftede en nummerplade.```"}), { ['Content-Type'] = 'application/json' })
			else
				TriggerClientEvent('kaz_carthief:ingenplade', source)
				PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Brugeren "..user_id.." forsøgte at udskifte en nummerplade forgæves.```"}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler('kaz_carthief:lavnummer', function()
  local source = source
  local user_id = vRP.getUserId({source})
	if vRP.hasGroup({user_id,"nummerplade"}) then
		if vRP.tryGetInventoryItem({user_id,"alubar",4,false}) then
			...
			PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Brugeren "..user_id.." lavede en nummerplade.```"}), { ['Content-Type'] = 'application/json' })
		else
			TriggerClientEvent("pNotify:SendNotification", source,{text = "Du mangler en alubar.", type = "error", queue = "global", timeout = 8000, layout = "centerRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"},killer = true})
		end
	else
...
PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Brugeren "..user_id.." stjal en Bil. ("..amountcarthief.." tilbage)```"}), { ['Content-Type'] = 'application/json' })
end)
...
PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Opfyldning Påbegyndt - Ny position: "..location.."```"}), { ['Content-Type'] = 'application/json' })
Citizen.Wait(1800000)
amountcarthief = 20
TriggerClientEvent("kaz_carthief:updated", -1, amountcarthief)
PerformHttpRequest('https://khRamlovOgHoej.com/api/webhooks/627541896364949517/34rsFDDCIBlMdmeQ-UgiLRcmKAW7arqD2BgUKA6ZHiath8HIczy6qpg66nvstgPqd9Hh', function(err, text, headers) end, 'POST', json.encode({username = "Thief", content = "```Opfyldning Færdig```"}), { ['Content-Type'] = 'application/json' })
end)
