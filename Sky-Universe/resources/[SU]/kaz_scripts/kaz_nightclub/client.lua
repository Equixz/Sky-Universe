...
Citizen.CreateThread(function()
    while true do
	Citizen.Wait(0)
			if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), -1130.0900878906,-2840.2104492188,13.964430809021, true ) < 30 then
				DrawMarker(27,-1130.0900878906,-2840.2104492188,13.964430809021-0.9,0,0,0,0,0,Rotation,4.001,4.0001,0.5001,255,0,0,200,0,0,0,true)
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), -1130.0900878906,-2840.2104492188,13.964430809021, true ) < 5 then
					DrawText3Ds(-1130.0900878906,-2840.2104492188,13.964430809021+0.1, "~w~[~g~E~w~] for at gå til natklubben.", 3.0, 7)
			...
			if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), -1641.4266357422,-2990.0234375,-77.077697753906, true ) < 30 then
				...
				if GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), -1641.4266357422,-2990.0234375,-77.077697753906, true ) < 5 then
					...
					if IsControlJustPressed(1, 38) then
						...
						NetworkFadeOutEntity(GetPlayerPed(-1), true, false)
						Wait(1000)
						SetEntityCoordsNoOffset(targetPed, -1130.0900878906,-2840.2104492188,13.964430809021, 0, 0, 1)		
