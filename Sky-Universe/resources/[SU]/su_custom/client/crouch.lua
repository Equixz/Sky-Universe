...
RegisterNetEvent('kaz_gidsel:nocrouch') 
AddEventHandler('kaz_gidsel:nocrouch', function()
	nocrouch = true
	Wait(60000)
	nocrouch = false
end)

RegisterNetEvent('kaz_gidsel:crouch') 
AddEventHandler('kaz_gidsel:crouch', function()
	nocrouch = false
end)
