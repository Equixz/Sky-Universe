...
Citizen.CreateThread(function()
    while true do
        ...
        if IsPedShooting(player) then
			silencer = HasPedGotWeaponComponent(player, GetHashKey("WEAPON_PISTOL_MK2"), GetHashKey("COMPONENT_AT_PI_SUPP_02"))
...
function sendDispatch2(x,y,z,message)
    TriggerServerEvent('dispatch2', x,y,z,message)
end
