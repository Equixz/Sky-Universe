...
RegisterNetEvent("bindnow")
AddEventHandler('bindnow', function()
  Wait(0)
...
RegisterCommand("bind", function(source, args, raw)
    TriggerEvent("bindnow")
end, false)
--[[
RegisterNetEvent("eskorternow")
AddEventHandler('eskorternow', function()
  Wait(0)
      if not IsPedInAnyVehicle(GetPlayerPed(-1),false) then
      TriggerServerEvent('handcuff:dragHim')
    end
end)

RegisterCommand("eskorter", function(source, args, raw)
    TriggerEvent("eskorternow")
end, false)

RegisterNetEvent("tagudafbilnow")
AddEventHandler('tagudafbilnow', function()
  Wait(0)
      if not IsPedInAnyVehicle(GetPlayerPed(-1),false) then
      TriggerServerEvent("handcuff:getoutvehicleHim", cplayer)
    end
end)

RegisterCommand("tagudafbil", function(source, args, raw)
    TriggerEvent("tagudafbilnow")
end, false)

RegisterNetEvent("saetibilnow")
AddEventHandler('saetibilnow', function()
  Wait(0)
      if not IsPedInAnyVehicle(GetPlayerPed(-1),false) then
      TriggerServerEvent("handcuff:getinvehicleHim", cplayer)
    end
end)

RegisterCommand("saetibil", function(source, args, raw)
    TriggerEvent("saetibilnow")
end, false)
